...
using NetFramework;
using OpenServer.Handler;
using GameProtocol;
using OpenServer.Handler.LoginHandler;
...
namespace OpenServer
{
    ...
    class HandlerCenter : AbsHandlerCenter
    {
        ...
        {
            lua = LuaSingleton.getInstance();
            lua.RegisterFunction("senMessage", this, this.GetType().GetMethod("MessageSend"));
        }
